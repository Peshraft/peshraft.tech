(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'pricing.intro':
        'Every project starts with a free consultation. Website builds from as low as $50 — transparent packages for Afghan businesses of every size.',
      'pricing.consultation.badge': 'Free consultation',
      'pricing.consultation.title': 'Not sure where to start? Talk to us first.',
      'pricing.consultation.lead':
        'We\'ll learn about your business, recommend the right plan, and give you a clear quote — no obligation and no pressure.',
      'pricing.consultation.cta': 'Book a free consultation',
    ...
    ps: {
      ...
      'movement.footer.linkPricing': 'نرخونه',
      ...
      'pricing.intro':
        'هره پروژه د وړیا مشورې سره پیل کیږي. د ویب پاڼو جوړښت له $50 څخه — د هر افغان سوداګرۍ لپاره روښانه بستې.',
      'pricing.consultation.badge': 'وړیا مشوره',
      'pricing.consultation.title': 'نه پوهیږئ له کومه پیل وکړئ؟ لومړی زموږ سره خبرې وکړئ.',
      'pricing.consultation.lead':
        'موږ ستاسو سوداګري پیژنو، سم پلان وړاندیز کوو او روښانه نرخ درکوو — بې مکلفیت او بې فشار.',
      'pricing.consultation.cta': 'وړیا مشوره ونیسئ',
    ...
    prs: {
      ...
      'movement.footer.linkPricing': 'قیمت‌ها',
      'movement.footer.connectTitle': 'ارتباط',
      'movement.footer.socialFacebook': 'فیسبوک',
      'movement.footer.socialLinkedin': 'لینکدین',
      ...
      'pricing.intro':
        'هر پروژه با مشاوره رایگان شروع می‌شود. ساخت وب‌سایت از ۵۰ دلار — بسته‌های روشن برای هر کسب‌وکار افغانی.',
      'pricing.consultation.badge': 'مشاوره رایگان',
      'pricing.consultation.title': 'نمی‌دانید از کجا شروع کنید؟ اول با ما صحبت کنید.',
      'pricing.consultation.lead':
        'درباره کسب‌وکار شما می‌شنویم، پلان مناسب پیشنهاد می‌دهیم و قیمت روشن می‌دهیم — بدون تعهد و بدون فشار.',
      'pricing.consultation.cta': 'رزرو مشاوره رایگان',
