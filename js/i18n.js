(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'pricing.starter.f1': 'Website — up to 5 pages',
      ...
      'pricing.starter.f5': '2 GB SSD · 50 MB/s bandwidth',
    ...
    ps: {
      ...
      'pricing.starter.f1': 'ویب پاڼه — تر ۵ پاڼو پورې',
      ...
      'pricing.starter.f5': '۲ GB SSD · ۵۰ MB/s بانډویډت',
    ...
    prs: {
      ...
      'pricing.starter.f1': 'وب‌سایت — تا ۵ صفحه',
      ...
      'pricing.starter.f5': '۲ GB SSD · پهنای باند ۵۰ MB/s',
