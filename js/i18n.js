(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'pricing.promo.li8': 'Bandwidth speed: 50 MB/s',
      ...
      'pricing.starter.f4': '2 GB SSD · 50 MB/s bandwidth',
      'pricing.starter.f5': '1 free domain (1st year)',
      'pricing.starter.f6': 'Email support — 48h response',
      'pricing.starter.f7': '2 revision rounds · 7–10 day delivery',
      'pricing.business.popular': 'Best value',
      'pricing.business.name': 'Business',
      'pricing.business.tag': 'Growing businesses & service brands',
      'pricing.business.price': '$399',
      'pricing.business.hosting': '+ $19.99/mo hosting',
      ...
      'pricing.business.f4': '5 GB SSD · 100 MB/s bandwidth',
      'pricing.business.f5': '1 free domain + 1 subdomain',
      'pricing.business.f6': 'Basic on-page SEO setup',
      'pricing.business.f7': 'Chat & email support — 24h',
      'pricing.business.f8': '4 revision rounds',
      'pricing.premium.name': 'Premium',
      'pricing.premium.tag': 'Established brands & higher traffic',
      'pricing.premium.price': '$899',
      'pricing.premium.hosting': '+ $29.99/mo hosting',
      'pricing.premium.f1': 'Unlimited pages',
      'pricing.premium.f2': 'Custom UI/UX design',
      'pricing.premium.f3': 'Advanced motion & interactions',
      'pricing.premium.f4': '20 GB SSD · unlimited bandwidth speed*',
      'pricing.premium.f5': 'Free domain + 3 subdomains',
      'pricing.premium.f6': 'Full SEO audit & setup',
      'pricing.premium.f7': 'Priority support — 4h response',
      'pricing.premium.f8': 'Unlimited revisions',
      'pricing.cta': 'Request this plan',
      'pricing.footnote': '* Unlimited bandwidth speed on Premium is subject to fair-use policy.',
    ...
    ps: {
      ...
      'pricing.promo.li8': 'د بانډویډت چټکتیا: ۵۰ MB/s',
      ...
      'pricing.starter.f4': '۲ GB SSD · ۵۰ MB/s بانډویډت',
      'pricing.starter.f5': '۱ وړیا ډومین (لومړی کال)',
      'pricing.starter.f6': 'د بریښنالیک ملاتړ — ۴۸ ساعته ځواب',
      'pricing.starter.f7': '۲ بیاکتنې · ۷–۱۰ ورځې تحویل',
      'pricing.business.name': 'بیزنس',
      'pricing.business.tag': 'ودېدونکې سوداګرۍ او خدماتي برانډونه',
      'pricing.business.price': '$399',
      'pricing.business.hosting': '+ $19.99/میاشت هسټینګ',
      ...
      'pricing.business.f4': '۵ GB SSD · ۱۰۰ MB/s بانډویډت',
      'pricing.business.f5': '۱ وړیا ډومین + ۱ سب ډومین',
      'pricing.business.f6': 'د پاڼې اساسي SEO تنظیم',
      'pricing.business.f7': 'چټ او بریښنالیک ملاتړ — ۲۴ ساعته',
      'pricing.business.f8': '۴ دورې بیاکتنې',
      'pricing.premium.name': 'پریمیم',
      'pricing.premium.tag': 'پراخ برانډونه او لوړ ټرافیک',
      'pricing.premium.price': '$899',
      'pricing.premium.hosting': '+ $29.99/میاشت هسټینګ',
      'pricing.premium.f1': 'نامحدود پاڼې',
      'pricing.premium.f2': 'ځانګړی UI/UX ډیزاین',
      'pricing.premium.f3': 'پرمختللې حرکت او تعامل',
      'pricing.premium.f4': '۲۰ GB SSD · نامحدود د بانډویډت چټکتیا*',
      'pricing.premium.f5': 'وړیا ډومین + ۳ سب ډومینونه',
      'pricing.premium.f6': 'بشپړ SEO ارزونه او تنظیم',
      'pricing.premium.f7': 'لومړیتوب ملاتړ — ۴ ساعته ځواب',
      'pricing.premium.f8': 'نامحدود بیاکتنې',
      'pricing.cta': 'دا پلان غواړئ',
      'pricing.footnote': '* د پریمیم په نامحدود د بانډویډت چټکتیا باندې د مناسب کارونې تګلاره پلي کېږي.',
    ...
    prs: {
      ...
      'pricing.promo.li8': 'سرعت پهنای باند: ۵۰ MB/s',
      ...
      'pricing.starter.f4': '۲ GB SSD · پهنای باند ۵۰ MB/s',
      'pricing.starter.f5': '۱ دامنه رایگان (سال نخست)',
      'pricing.starter.f6': 'پشتیبانی ایمیل — پاسخ تا ۴۸ ساعت',
      'pricing.starter.f7': '۲ دور بازبینی · تحویل ۷–۱۰ روز',
      'pricing.business.name': 'بیزنس',
      'pricing.business.tag': 'کسب‌وکارهای در حال رشد و برندهای خدماتی',
      'pricing.business.price': '$399',
      'pricing.business.hosting': '+ $19.99 در ماه میزبانی',
      'pricing.business.f1': 'تا ۱۵ صفحه',
      'pricing.business.f2': 'طراحی سفارشی از صفر',
      'pricing.business.f3': 'کاملاً واکنش‌گرا · همه مرورگرها',
      'pricing.business.f4': '۵ GB SSD · پهنای باند ۱۰۰ MB/s',
      'pricing.business.f5': '۱ دامنه رایگان + ۱ زیردامنه',
      'pricing.business.f6': 'تنظیم پایه سئو در صفحه',
      'pricing.business.f7': 'چت و ایمیل — پاسخ تا ۲۴ ساعت',
      'pricing.business.f8': '۴ دور بازبینی',
      'pricing.premium.name': 'پریمیوم',
      'pricing.premium.tag': 'برندهای تثبیت‌شده و ترافیک بالاتر',
      'pricing.premium.price': '$899',
      'pricing.premium.hosting': '+ $29.99 در ماه میزبانی',
      'pricing.premium.f1': 'صفحات نامحدود',
      'pricing.premium.f2': 'طراحی سفارشی UI/UX',
      'pricing.premium.f3': 'انیمیشن و تعامل پیشرفته',
      'pricing.premium.f4': '۲۰ GB SSD · سرعت پهنای باند نامحدود*',
      'pricing.premium.f5': 'دامنه رایگان + ۳ زیردامنه',
      'pricing.premium.f6': 'ممیزی و راه‌اندازی کامل سئو',
      'pricing.premium.f7': 'پشتیبانی اولویت‌دار — پاسخ تا ۴ ساعت',
      'pricing.premium.f8': 'بازبینی نامحدود',
      'pricing.cta': 'درخواست این پلان',
      'pricing.footnote': '* سرعت پهنای باند نامحدود پریمیوم تابع سیاست استفاده منصفانه است.',
